...
/obj/item/weapon/cleaner/afterattack(atom/A as mob|obj, mob/user as mob)
	...
	var/finalcolour
	for(var/datum/reagent/re in D.reagents.reagent_list) // natural colour mixing bullshit/algorithm
		if(!finalcolour)
...
/*
 *  Hope it's okay to stick this shit here: it basically just turns a hexadecimal colour into rgb
 */
